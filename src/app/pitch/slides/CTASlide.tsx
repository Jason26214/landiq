	...
	return (
		<div className="absolute inset-0 flex items-center justify-center overflow-hidden">
			...
			<div
				...
				style={{ backgroundImage: `url('${process.env.NEXT_PUBLIC_BASE_PATH ?? ''}/images/lifestyle/lifestyle-community-walk.jpg')` }}
			/>
			{/* Dark green overlay */}
			...
			<div className="relative text-center z-10">
				...
				<FadeIn delay={0.8}>
					<div className="mt-12 space-y-2">
						<p className="font-sans text-sm text-primary-300">hello@landiq.com.au</p>
						<p className="font-sans text-sm text-primary-400">www.landiq.com.au</p>
					</div>
				</FadeIn>
