...
export function DemoSlide() {
	...
	useEffect(() => {
		...
		const initMap = async () => {
			...
			// eslint-disable-next-line @typescript-eslint/no-explicit-any -- Leaflet internal cleanup for React Strict Mode
				...
				<div className="p-4 border-t border-primary-700/50 bg-primary-900/50">
					<div className="grid grid-cols-2 gap-3">
						<div className="text-center">
							...
							<p className="font-sans text-[10px] text-primary-400 uppercase tracking-wider">
								Data Sources
							</p>
						</div>
						<div className="text-center">
			...
			<AnimatePresence mode="wait">
				...
				>
					<div className="p-6 border-b border-surface-300">
						...
						<p className="font-sans text-xs text-surface-500 mt-1">{parcel.lot}</p>
					</div>
							...
							return (
								...
								>
									...
									<div className="min-w-0">
										...
										<p
											className={`font-sans text-sm font-medium mt-0.5 ${status.color}`}
										>
											{row.value}
										</p>
									</div>
