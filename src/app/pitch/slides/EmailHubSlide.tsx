...
const emails = [
  {
    ...
    preview: "Hi John, please find attached the revised yield analysis reflecting the heritage overlay...",
    time: "10:32 AM",
    account: 0,
    starred: true,
    attachment: true,
  ...
  },
  {
    ...
    preview: "Dear Applicant, further to our assessment of the above Development Application, we require...",
    time: "9:15 AM",
    account: 2,
    starred: false,
    attachment: true,
  ...
  },
  {
    ...
    preview: "Please find the preliminary site investigation report for 88 Collins Street. Key findings...",
    time: "Yesterday",
    account: 0,
    starred: false,
    attachment: true,
  ...
  },
  {
    ...
    preview: "Hi John, I have an off-market industrial site in Waterloo that may suit your acquisition brief...",
    time: "Yesterday",
    account: 1,
    starred: true,
    attachment: false,
  ...
  },
  {
    ...
    preview: "Your planning certificate for Lot 1 DP598704 is now available. Certificate number...",
    time: "2 days ago",
    account: 2,
    starred: false,
    attachment: true,
        ...
        <div className="col-span-4">
          <FadeIn>
            ...
            <p className="font-body text-[15px] text-surface-500 mt-4 leading-relaxed">
              Connect multiple email accounts. AI automatically links emails to
              land sites, tags by category, and surfaces attachments — no more
              digging through inboxes.
            </p>
          </FadeIn>
            ...
            <div className="mt-6 space-y-2">
              {[
                ...
                <div key={i} className="flex items-center gap-2.5">
                  <f.icon className="w-3.5 h-3.5 text-primary-600 shrink-0" strokeWidth={1.5} />
                  <span className="font-sans text-xs text-surface-500">{f.text}</span>
                </div>
              ))}
            </div>
          </FadeIn>
          ...
          >
            ...
            <div className="px-4 py-2.5 bg-surface-100 border-b border-surface-300 flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 bg-white border border-surface-300 rounded-lg px-2.5 py-1.5">
                <Search className="w-3.5 h-3.5 text-surface-400" strokeWidth={1.5} />
              ...
              <button className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg border border-surface-300 hover:bg-surface-200 transition-colors">
                ...
                <span className="font-sans text-[11px] text-surface-500">Filter</span>
              </button>
            </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        <div className="flex items-center gap-1.5 ml-auto shrink-0">
                          ...
                          {email.attachment && (
                            <Paperclip className="w-3 h-3 text-surface-400" strokeWidth={1.5} />
                          )}
                          <Clock className="w-3 h-3 text-surface-400" strokeWidth={1.5} />
                      ...
                      <div className="flex items-center gap-2 mt-1.5">
                        <span className={`px-2 py-0.5 rounded-full text-[9px] font-medium ${email.tagColor}`}>
                          {email.tag}
                        </span>
                        {email.linkedSite && (
