        ...
        <div className="col-span-5">
          <FadeIn>
            ...
            <p className="font-body text-[15px] text-surface-500 mt-4 leading-relaxed">
              Every feasibility report, consultant document, contract, and
              planning submission — organised, searchable, and version-controlled
              in one place.
            </p>
          </FadeIn>
          ...
          >
            ...
            <div className="px-5 py-3 bg-surface-100 border-b border-surface-300 flex items-center gap-3">
              ...
              <button className="flex items-center gap-1.5 px-3 py-2 rounded-lg border border-surface-300 bg-white hover:bg-surface-100 transition-colors">
                <Filter className="w-3.5 h-3.5 text-surface-500" strokeWidth={1.5} />
                <span className="font-sans text-xs text-surface-500">Filter</span>
              </button>
              <button className="flex items-center gap-1.5 px-3 py-2 rounded-lg border border-surface-300 bg-white hover:bg-surface-100 transition-colors">
                <FolderOpen className="w-3.5 h-3.5 text-surface-500" strokeWidth={1.5} />
                <span className="font-sans text-xs text-surface-500">All Projects</span>
              </button>
            </div>
              ...
              {documents.map((doc) => (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <doc.icon className="w-4 h-4 text-primary-600 shrink-0" strokeWidth={1.5} />
                    <div className="min-w-0">
                      <span className="font-sans text-[13px] text-primary-900 block truncate">
                        {doc.name}
                      </span>
                      <span className={`inline-block mt-0.5 px-2 py-0.5 rounded-full text-[10px] font-medium ${doc.tagColor}`}>
                        {doc.tag}
                      </span>
                    </div>
                  </div>
                  <span className="font-sans text-xs text-surface-500">{doc.type}</span>
                  <div className="flex items-center gap-1.5 min-w-0">
                    <Users className="w-3 h-3 text-surface-400 shrink-0" strokeWidth={1.5} />
