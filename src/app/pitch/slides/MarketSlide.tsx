...
const stats = [
  ...
  { icon: DollarSign, value: 250, prefix: "$", suffix: "K+", label: "Due diligence per acquisition" },
        ...
        <div className="col-span-5">
          <FadeIn>
            ...
            <p className="font-body text-[16px] text-surface-500 mt-6 leading-relaxed">
              Property development in Australia involves complex due diligence
              across fragmented government systems. The process costs developers
              tens of thousands per site — and months of delay.
            </p>
          </FadeIn>
        </div>
        ...
        <div className="col-span-7">
          <StaggerContainer className="grid grid-cols-2 gap-0" delay={0.5}>
            {stats.map((s) => (
              ...
              >
                <s.icon className="w-5 h-5 text-primary-600 mb-4" strokeWidth={1.5} />
                ...
                <p className="font-sans text-sm text-surface-500 mt-3">
                  {s.label}
                </p>
              </motion.div>
            ))}
